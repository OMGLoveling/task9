...
describe("Student", () => {
  ...
  it("5 should introduce there is not class assigned to this student, when this studen d" +
  ...
  it("6 should introduce student is a leader, when class assign this student to be a lea" +
      "der",
  () => {
    let clazz = new Class(2);
    let student = new Student("Tom", 21, clazz);
...
describe("Teacher", () => {
  ...
  it("7 should have field name, age and klass", () => {
  ...
  it("8 should overwrite Person introduce and show all classes this teacher teaches, whe" +
  ...
  it("9 should show no class this teacher teaches info, when there is no class assgin to" +
      " this teacher",
  () => {
  ...
  it("10 should return false, when student hasn't been appended this student to this clas" +
  ...
  it("11 should return true, when student has been appended this student to this class wh" +
      "ich teacher teaches",
  () => {
    let clazz1 = new Class(2);
    let clazz2 = new Class(3);
...
describe("Class", () => {
  ...
  it("12 should Assign team leader successfully, when student is appended to class", () => {
    let clazz = new Class(2);
    let student = new Student("Tom", 21, clazz);
    clazz.appendMember(student);
  ...
  it("13 should Assign team leader failed, when student doesn't append to class", () => {
    let clazz = new Class(2);
    let student = new Student("Tom", 21, clazz);
    let result = clazz.assignLeader(student);
